...
ENDFLAGS = $(LINKFLAGS)
OUTPUT = test
OBJECTS = geometry.o collider.o myVector.o myList.o myMatrix.o text_driver.o graphics.o physics.o body.o game_state.o poltergeist.o input.o parallax.o compound.o events.o
